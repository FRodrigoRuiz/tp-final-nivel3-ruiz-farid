<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="FormularioArticulo.aspx.cs" Inherits="tp_final_nivel_3.FormularioArticulo" %>
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="mb-3">
                ...
                <asp:RequiredFieldValidator CssClass="validacion" ErrorMessage="Ingrese un código" ControlToValidate="txtCodigo" runat="server" />
            </div>
            <div class="mb-3">
                <label for="txtPrecio" class="form-label">Precio: </label>
                <asp:TextBox runat="server" ID="txtPrecio" CssClass="form-control" />
                <asp:RequiredFieldValidator CssClass="validacion" ErrorMessage="Ingrese el precio" ControlToValidate="txtPrecio" runat="server" />
            </div>
            <div class="mb-3">
